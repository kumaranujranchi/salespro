...
export function LandingPage() {
    ...
    const [showSecurityWhitepaper, setShowSecurityWhitepaper] = useState(false);
    ...
    return (
        <div className="min-h-screen bg-slate-50 overflow-x-hidden font-sans text-gray-900">
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <div className="flex space-x-4">
                                <a 
                                    href="https://www.facebook.com/realsalepro" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-white/5 rounded-full hover:bg-[#10B981] transition-colors cursor-pointer flex items-center justify-center text-white"
                                >
            ...
            <Modal
                isOpen={showSecurityWhitepaper}
                onClose={() => setShowSecurityWhitepaper(false)}
                title="Security Whitepaper - Enterprise Security Architecture"
                size="lg"
            >
                <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <div className="bg-white p-4 border border-gray-100 rounded-xl">
                                <p className="text-sm font-semibold text-gray-800 mb-1">AES-256 Bit Encryption</p>
                                <p className="text-xs text-gray-500 leading-relaxed">All customer data is encrypted at rest using industry-standard Advanced Encryption Standard with 256-bit keys.</p>
                            </div>
                            <div className="bg-white p-4 border border-gray-100 rounded-xl">
                                <p className="text-sm font-semibold text-gray-800 mb-1">TLS 1.3 Transport</p>
                                <p className="text-xs text-gray-500 leading-relaxed">Data in transit is protected by Transport Layer Security (TLS) 1.3, ensuring secure communication between browsers and servers.</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white p-4 border border-gray-100 rounded-xl">
                                <p className="text-sm font-semibold text-gray-800 mb-1">Role-Based Access (RBAC)</p>
                                <p className="text-xs text-gray-500 leading-relaxed">Granular permission system ensures users can only access data required for their specific role (Director, Sales, CRM, etc.).</p>
                            </div>
                            <div className="bg-white p-4 border border-gray-100 rounded-xl">
                                <p className="text-sm font-semibold text-gray-800 mb-1">Tenant Isolation</p>
                                <p className="text-xs text-gray-500 leading-relaxed">Strict multi-tenancy architecture ensures complete data isolation between different organizations on the platform.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                            <div className="p-4 bg-gray-50 rounded-xl">
                                <p className="text-xs font-bold text-gray-900">Weekly Backups</p>
                                <p className="text-[10px] text-gray-500 italic">Automated snapshots</p>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-xl">
                                <p className="text-xs font-bold text-gray-900">24/7 Monitoring</p>
                                <p className="text-[10px] text-gray-500 italic">Global uptime checks</p>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-xl">
                                <p className="text-xs font-bold text-gray-900">Database Options</p>
                                <p className="text-[10px] text-gray-500 italic">On-premise supported</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-4 mt-4 border-t border-gray-100 text-center">
                        <p className="text-xs text-gray-400">
                            For further inquiries or a detailed security audit report, please contact our security team at <span className="font-semibold">security@realsalepro.com</span>
                        </p>
                    </div>
                </div>
            </Modal>
